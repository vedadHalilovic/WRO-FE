...
| AZ-Delivery ESP32   | Gyro/motor controller                                                                                                      | ESP32 NodeMCU Module WLAN WiFi Development Board Dev Kit C V2 with CP2102 | Mounted to breadboard                                                                    |
...
| Motor driver        | Controls the motors using PWM signals received from the ESP32 and powering the drive motor from the 11-12V source(battery) | Adafruit TB6612 motor driver                                              | Mounted to breadboard                                                                    |
| MPU-6050           | Used to determine when the 90-degree turn is achieved                                                                      | MPU-6050                                                             | Mounted to breadboard                                                                    |
...
| 11.1V Li-Po battery | Powering the robot                                                                                                         | GOLDBAT 11.1V 5000mAh 3S 50C LiPo RC Battery                              | Mounted using adhesive                                                                                     |
